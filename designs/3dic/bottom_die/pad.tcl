...
make_tracks BONDING_LAYER -x_pitch 0.1 -y_pitch 0.1
...
# define_pin_shape_pattern -layer BONDING_LAYER -region {10 10 3210 2210} -size {1 1} -x_step 30 -y_step 10

# set_io_pin_constraint -region "up:{10 10 3210 2210}" -pin_names $cluster1 
...
# random place
define_pin_shape_pattern -layer BONDING_LAYER -region {291 1582 2933 2104} -size {1 1} -x_step 30 -y_step 15

set_io_pin_constraint -region "up:{10 10 3210 2210}" -pin_names [concat $cluster1 $cluster2 $cluster2 $cluster3 $cluster4]
# special pad
place_pin -pin_name clk -pin_size {1 1} -location {1610 513} -layer BONDING_LAYER
