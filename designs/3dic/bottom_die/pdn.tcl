...
# standard cell grid
####################################
define_pdn_grid -name {macro} -macro -voltage_domains {CORE} -grid_over_boundary -instances {l1d_u l1i_u}
...
add_pdn_stripe -grid {block} -layer {Metal4} -width {2} -spacing {0.56} -pitch {65} -offset {12}
...
add_pdn_connect -grid {macro} -layers {Metal1 Metal4}
