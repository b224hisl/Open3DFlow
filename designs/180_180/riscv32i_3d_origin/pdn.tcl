...
add_pdn_stripe -grid {block} -layer {Metal4} -width {4.480} -spacing {0.56} -pitch {44.8} -offset {22.4} -extend_to_core_ring
...
add_pdn_ring -grid block -layer {Metal1 Metal4} -widths 5.04 -spacings 2 -core_offsets 5