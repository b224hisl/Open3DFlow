...
export DIE_AREA = 0 0 45000 45000
export CORE_AREA = 0 0 41000 41000
...
export NETLIST_CUST = ./designs/$(PLATFORM)/$(DESIGN_NICKNAME)/soc_ddr_l3.v
export IO_PLACER_H                           = L3_h
export IO_PLACER_V                           = L3_v
export TAPCELL_TCL = ./designs/$(PLATFORM)/$(DESIGN_NICKNAME)/tapcell.tcl
export PACKAGE = 1
export MACRO_PLACEMENT_TCL = ./designs/$(PLATFORM)/$(DESIGN_NICKNAME)/macro_fab_explore.tcl
...
export MAX_ROUTING_LAYER = L3_v
export MIN_ROUTING_LAYER = L3_h
...
export FLOW_VARIANT = L3_fab_explore