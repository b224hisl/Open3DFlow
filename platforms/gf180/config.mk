...
export KLAYOUT_TECH_FILE                      = $(PLATFORM_DIR)/KLayout/gf180mcu_5LM_1TM_$(KVALUE)K_$(TRACK_OPTION).lyt
export KLAYOUT_LEF_FILE                       = $(PLATFORM_DIR)/KLayout/tech_$(TRACK_OPTION)_$(METAL_OPTION).lef
export GDS_LAYER_MAP                          = $(abspath $(PLATFORM_DIR)/gds/$(TRACK_OPTION)/gf180mcu_5LM_1TM_$(KVALUE)K_$(TRACK_OPTION)_edi2gds.layermap)
